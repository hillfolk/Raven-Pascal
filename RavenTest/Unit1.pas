...
begin
  ...
  begin
    ...
    input_string := '{ "event_id" : "' + edtEvent_Id.Text + '",' +
      ' "culprit" : "' + edtCulprit.Text + '",' + ' "timestamp" : "' +
      edtTimestamp.Text + '",' + ' "message" : "' + edtMessage.Text + '",' +
      ' "tags" : {"' + edtTagKey.Text + '":"' + edtTagValue.Text + '"},' +
      '"exception":[{' + '"type" : "' + edtType.Text + '",' + '"value" : "' +
      edtValue.Text + '",' + '"module" : "' + edtModule.Text + '"}]}';
